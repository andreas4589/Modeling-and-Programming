...
namespace Reversi
{
    ...
    public partial class Form1 : Form
    {
            ...
            for (int n = 0; n < kolommen; n++)
            {
                for (int t = 0; t < rijen; t++)
                {
                    if (vraagBol(n, t) == true)
                        pea.Graphics.FillEllipse(Brushes.Blue, breedte / kolommen * n + bordx, hoogte / rijen * t + bordy, breedte / kolommen, hoogte / rijen);
        ...
        private void Beginstand()
        {
            ...
            int centerY = rijen / 2;
            veranderBol(centerX - 1, centerY - 1, true);
            veranderBol(centerX, centerY, true);
            veranderBol(centerX - 1, centerY, true);
            veranderBol(centerX, centerY - 1, true);
        }
